...
def top(input_list):
    ...
    return input_list[:size_input_list]
...
def delete_third_and_seventh(input_list):
    ...
    """
    input_list1=input_list[0:2]
    input_list2=input_list[3:7]
    input_list3=input_list1+input_list2
